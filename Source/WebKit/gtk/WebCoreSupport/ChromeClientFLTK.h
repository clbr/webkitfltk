...
#ifndef ChromeClientFLTK_h
#define ChromeClientFLTK_h
...
namespace WebKit {
	...
	public:
		...
		FLTKAdjustmentWatcher* adjustmentWatcher() { return &m_adjustmentWatcher; }
	...
	private:
		...
		FLTKAdjustmentWatcher m_adjustmentWatcher;
