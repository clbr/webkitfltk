...
WEBKIT_API WebKitWebPluginDatabase *webkit_get_web_plugin_database(void);

WEBKIT_API WebKitFaviconDatabase *webkit_get_favicon_database(void);
...
webkit_context_menu_item_get_action(FLTKMenuItem * item);
*/

WEBKIT_API void
webkit_set_security_policy_for_uri_scheme(const char *scheme,
					  WebKitSecurityPolicy policy);

WEBKIT_API WebKitSecurityPolicy
webkit_get_security_policy_for_uri_scheme(const char *scheme);
