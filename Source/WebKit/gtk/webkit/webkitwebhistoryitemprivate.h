...
WebKitWebHistoryItem *webkit_web_history_item_new_with_core_item(PassRefPtr <
								 WebCore::
								 HistoryItem >);

WEBKIT_API char *webkit_web_history_item_get_target(WebKitWebHistoryItem *);

WEBKIT_API bool webkit_web_history_item_is_target_item(WebKitWebHistoryItem *);
